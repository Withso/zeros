...
export const ZSR_CONTRACT_TEST_FILES = Object.freeze([
  ...
  "apps/desktop/src/engine/agents/__tests__/gateway-cloud-admission.test.ts",
  "apps/desktop/src/engine/agents/__tests__/gateway-cloud-stop.test.ts",
  ...
  "apps/desktop/src/engine/agents/__tests__/gateway-cursor-credentials.test.ts",
  ...
  "apps/desktop/src/engine/agents/__tests__/gateway-decision-receipts.test.ts",
  ...
  "apps/desktop/src/engine/agents/__tests__/gateway-mcp-catalog.test.ts",
  "apps/desktop/src/engine/agents/__tests__/gateway-registry-refresh.test.ts",
  "apps/desktop/src/engine/agents/__tests__/gateway-session-tools.test.ts",
  ...
  "apps/desktop/src/engine/agents/containment/__tests__/cloud-coordinator-attestation.test.ts",
  "apps/desktop/src/engine/agents/containment/__tests__/cloud-coordinator-ownership.test.ts",
  "apps/desktop/src/engine/agents/containment/__tests__/cloud-coordinator-view.test.ts",
