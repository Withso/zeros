...
export function createGithubRoutes(
  ...
  app.post(
    ...
    async (c) => {
      ...
      try {
        ...
        // Only this backend writes these bytes, so a failure here is a bug or
  ...
  app.post(
    ...
    async (c) => {
      ...
      // duplicate audit row for a grant this backend no longer knows about.
      ...
      // backend, so the disconnect really did take effect.
      if (remoteFailure) {
        console.warn(
