// Vendored d3 for the standalone loaders preview (no build step / works over file://).
// d3-array@3.x + d3-geo@3.1.1 UMD, concatenated (both attach to window.d3; d3-geo
// depends on d3-array so array MUST come first). Used only by run-globe.js for the
// orthographic projection + geoPath SVG path generation. Upstream: https://d3js.org
