...
// the point: the app is open source, so a vague or flattering
...
//
//   • apps/desktop/src/renderer/platform/observability/analytics/posthog.ts   — autocapture/session recording
