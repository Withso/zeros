-- ──────────────────────────────────────────────────────────
-- 0024 — canonical cloud identity, ownership, and paid-work authority
--
...
ALTER TABLE organizations
  DROP CONSTRAINT personal_organizations_are_local_only;

-- The deployment feature gate and an active account entitlement still fail
-- Personal cloud closed. This column is only coarse product capability.
UPDATE organizations
SET cloud_workspaces_allowed = true
WHERE is_personal AND NOT cloud_workspaces_allowed;
