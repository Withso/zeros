  ...
  "inline-flex items-center rounded-sm border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-[3px] focus:ring-highlighted-bright/50",
  {
    variants: {
      variant: {
        ...
        // the call site: shared variants own typography, not `className`.
        accent:
        ...
        //
        // Typography lives in the variant, not the call site: 14px
 ...
 *  against — see OpenInBadgeMenu in shell/conversation/conversation-header.tsx. */
