...
//
// File resolution lives main-side (apps/desktop/electron/ipc/commands/agent-
...
import { useGitRefreshKey } from "@/renderer/shell/use-git-refresh-key";
...
export function ProjectContextChip({ agentId, cwd }: Props) {
  ...
  // Radix Popover (Popover from apps/desktop/src/renderer/shared/ui/primitives/popover.tsx) instead
