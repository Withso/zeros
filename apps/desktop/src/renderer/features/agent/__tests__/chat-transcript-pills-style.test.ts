...
//
// The settled contracts: concise by default, full on right-click, added state as
// a Button variant, no open/closed or budget chrome, transcript-only hover, and
// a live pill paired with a fixed chip.
...
const pills = () =>
  code("apps/desktop/src/renderer/features/agent/chat-transcript-pills.tsx");
const preview = () =>
  code("apps/desktop/src/renderer/features/agent/chat-transcript-preview.tsx");
const button = () =>
  code("apps/desktop/src/renderer/shared/ui/primitives/button.tsx");
...
describe("concise always, full only on right-click", () => {
  ...
  it("offers full only from the context menu", () => {
    ...
    // another name, which this surface deliberately avoids.
...
describe("the menu is reachable without a pointer", () => {
  // The full transcript lives behind right-click, which makes the context
...
describe("the added state is a Button variant, not an override", () => {
...
describe("open vs closed is not a distinction this feature makes", () => {
...
describe("no budget chrome anywhere", () => {
...
describe("hover shows the transcript and nothing else", () => {
...
describe("the pill is live and the chip is fixed", () => {
