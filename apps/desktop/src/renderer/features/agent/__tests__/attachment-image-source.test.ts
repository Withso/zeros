...
describe("AttachmentImageSourceCache", () => {
  ...
  it("threads retained-surface activity into composer image leases", () => {
    ...
    expect(read("apps/desktop/src/renderer/features/agent/composer-editor/pills.tsx")).toMatch(
      /enabled:\s*ctx\.attachmentImagesActive/,
    );
    expect(
      read("apps/desktop/src/renderer/features/agent/composer-editor/composer-editor-context.tsx"),
