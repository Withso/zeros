// ──────────────────────────────────────────────────────────
// device-local — per-client UI state in localStorage
// ──────────────────────────────────────────────────────────
//
...
//
//  • scroll positions — a reading offset is per viewport and has no meaning on
//    another client. Pure local UX.
//
// localStorage keeps this state at the rendering client boundary. Missing or
// disabled storage is tolerated: reads fall back to empty and writes are
// best-effort.
// ──────────────────────────────────────────────────────────
...
// ── One-time-per-workspace cost-bump toast flag ─────────────
//
...
// Tell the user ONCE per workspace, not per chat: every chat in the same
