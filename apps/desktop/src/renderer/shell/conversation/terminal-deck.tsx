// ──────────────────────────────────────────────────────────
// Conversation pane — Terminal-agent tab deck
// ──────────────────────────────────────────────────────────
//
// Mounted ONCE at the column level (a sibling of the pane tree inside
// ConversationPane's body stack). Renders every `kind: "terminal"`
...
//
// Visibility contract mirrors the workbench terminal panel:
...
import { paneForChat } from "../../state/chat-panes";
        ...
        const layer = (
          <div
            ...
            {...(!isActive
              ...
              : {})}
            className={cn(
              // `p-4` matches the workbench terminal panel's padding; the
