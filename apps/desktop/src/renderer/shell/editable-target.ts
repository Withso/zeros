...
// ──────────────────────────────────────────────────────────
//
// The app's global window-level chord handlers (⌥⌘B toggle Workbench,
...
// shortcut whenever a terminal was focused — the conversation pane terminal
// agents and the workbench terminal row both became shortcut dead
