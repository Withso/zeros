// ──────────────────────────────────────────────────────────
// useCustomWindowDrag — JS-driven window drag for application headers
// ──────────────────────────────────────────────────────────
//
...
// popover dismissal on the conversation/workbench headers, since both rows are
// drag handles and popover-trigger rows. This hook drops the CSS drag region
// and implements the drag explicitly through IPC.
//
...
import { isNativeRuntime, nativeInvoke } from "../platform/runtime";
...
const INTERACTIVE_SEL = [
  ...
  // their tag is a `<div>` / `<span>`. Covers tabs (workbench pills,
  // conversation pane chat tabs), Radix dropdowns/popovers, command menus, the
 ...
 *  pointerup fires. Squared to avoid a Math.sqrt() per pointermove. */
