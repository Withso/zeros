...
// Repository panel's openProject minus the foreign-worktree adoption dialog —
// the caller only needs a usable cwd, and full adoption stays a Repository panel
...
import { pickProjectFolder } from "../platform/app";
