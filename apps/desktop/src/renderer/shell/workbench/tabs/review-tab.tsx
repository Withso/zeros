...
//
// Mounted ONLY for a workspace with a PR (ReviewSurface guards + renders the
...
import type { ReviewSubtab } from "../tab-model";
...
export function ReviewView({
  ...
  refreshKey: number;
  /** Is the Review tab the visible workbench tab? Gates live polling. */
  active: boolean;
