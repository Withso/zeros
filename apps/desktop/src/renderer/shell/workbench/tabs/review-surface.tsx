// ──────────────────────────────────────────────────────────
// ReviewSurface — THE pinned workbench Review tab
// ──────────────────────────────────────────────────────────
//
// The PR review surface, second in workbench and never closable. Workbench owns one
...
export const ReviewSurface = React.memo(function ReviewSurface({
  tab,
  active,
  scope,
}: TabBodyProps) {
  ...
  const body =
    !workspace || isLocalMain || workspace.prNumber == null ? (
      ...
      <ReviewView
        ...
        // Live polling runs only while this is the visible workbench tab.
        active={active}
