...
/** Resolve omnibox input like a desktop browser: URL-shaped text navigates
 * directly, while ordinary text becomes a Google search. Explicit non-web
 * schemes stay rejected rather than being searched or handed to Chromium. */
export function resolveBrowserAddressInput(raw: string): string | null {
  ...
  // Keep this after localhost:PORT detection: that input resembles a URI
