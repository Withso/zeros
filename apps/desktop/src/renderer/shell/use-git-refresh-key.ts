...
// ──────────────────────────────────────────────────────────
//
// Every workbench surface (File viewers, the Changes/Files/Review tabs, the
...
//      (the workbench editor save, or a completed workbench Discard flow).
//
...
// workbench editor save. Coalesced on a short trailing timer per workspace — a
