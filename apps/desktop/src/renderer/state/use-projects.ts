 ...
 *  bar renders so Conversation pane surfaces stay reactive to project-list changes. */
...
// Workspace lists are renderer-wide server state. TopBar, Conversation pane, Workbench,
