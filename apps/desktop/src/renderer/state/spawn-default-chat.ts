...
// ──────────────────────────────────────────────────────────
//
// Product invariant: when a workspace is created or comes into view with no
// live chat, it always gets a fresh
// "Untitled" chat tab — there is no "no chat selected" state anymore
// (conversation/chat-view renders a dead pane for a null active chat since
// the EmptyComposer landing was deleted 2026-06-18).
//
// This sits between the workspace-creation handlers in Repository panel and
...
// <AutoBindAgent> in conversation/chat-view binds the resolved default on
