// The single-identity resolver for the unified storage architecture.
// zerosDataDir() naming is covered by agents/__tests__/session-paths.test.ts; this
// pins the NEW exports that apps/desktop/electron/main.ts relies on to fold Electron's userData,
