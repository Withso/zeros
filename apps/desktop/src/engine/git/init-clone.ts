...
//
// Both surfaces are driven by the repository navigation's "Add repository"
// menu: Quick start (init a new repo from a template), and Open
...
// apps/desktop/src/renderer/shell/add-project-provider.tsx. So adding a repo DOES land the
