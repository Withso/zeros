...
// are unchanged; `renderer/shared/lib/branch-name.ts` re-exports it for the renderer.
//
...
// module the renderer imports directly (renderer/features/agent/env-vault.ts).
//
 ...
 *  workspace creation.
 *
 *  The prefix is a NAME, not a fragment: the
