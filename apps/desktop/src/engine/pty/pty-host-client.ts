...
//
// Runtime resolution (set by apps/desktop/electron/sidecar.ts; falls back for a
...
function resolveHostScript(): string | null {
  ...
  // Source mode (e.g. `bun apps/desktop/src/cli.ts` with no Electron host): the .cjs sits
