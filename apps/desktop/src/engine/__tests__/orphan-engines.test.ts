...
describe("dev orphan engine matching", () => {
  const cliPath = "/Users/dev/Projects/zeros/worktree-a/apps/desktop/src/cli.ts";
  const command =
  ...
  it("preserves quoted and escaped paths when splitting ps commands", () => {
    expect(
      splitProcessCommand(
        `/opt/homebrew/bin/bun "/Users/dev/Zeros copy/apps/desktop/src/cli.ts" serve ` +
          "--root /Users/dev/My\\ Repo --port 25803",
      ),
    ).toEqual([
      "/opt/homebrew/bin/bun",
      "/Users/dev/Zeros copy/apps/desktop/src/cli.ts",
      "serve",
      "--root",
      "/Users/dev/My Repo",
      "--port",
...
describe("range-listener reaping (shouldReapRangeListener)", () => {
  ...
  const devEngine =
    "/opt/homebrew/bin/bun /Users/dev/Zeros/apps/desktop/src/cli.ts serve --root /Users/dev/proj --port 24293";
  const ptyHost =
