// ──────────────────────────────────────────────────────────
// Iframe picker script — Design Mode element picker
// ──────────────────────────────────────────────────────────
//
// This picker replaces the old WebContentsView preload script. It runs
...
(function() {
  ...
  // pages with transformed ancestors. Document
  // coords + absolute keep the overlay glued to its element
  // across scroll. The offset must remain stable while the page scrolls.
