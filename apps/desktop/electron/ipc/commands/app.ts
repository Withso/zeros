...
// where IS_DEV (apps/desktop/electron/runtime-mode.ts) is the source of truth.
//
...
export interface AppInfo {
   ...
   *  scheme apps/desktop/electron/deep-link.ts registered + validates. `runtimeMode` can't
...
// ──────────────────────────────────────────────────────────
//
// The renderer's apps/desktop/src/renderer/platform/settings.ts is localStorage-backed, which the
