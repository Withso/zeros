...
// stay in sync with the Action AND with apps/control-plane/src/auth.ts.
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    // CORS preflight. The packaged file:// desktop renderer posts across
    // origins, so it still performs a browser CORS handshake.
