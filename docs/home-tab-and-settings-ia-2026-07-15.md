...
│              │                                             │
├──────────────┤                                             │
│ Ⓐ Jordan ⚙   │                                             │  ← profile card: name · plan · gear → Settings
└──────────────┴─────────────────────────────────────────────┘
```
