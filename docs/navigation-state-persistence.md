...
| Workbench tab strip, open file tabs, active tab, browser history      | workspace folder             | `workbenchByScope`                                          | fresh Open file + Changes + Review slice                                        |
| Changes scope and turn filter                                         | Git target/workspace id      | changes-filter store                                        | All changes / no turn                                                           |
| Changes flat/tree and selected file/viewer mode                       | workspace Changes tab        | `WorkbenchTab.changesView`, file intent fields, `viewerMode` | Flat; entry-point mode for a new path                                          |
| Review Changes/Description/Commits/Checks/Reviews                     | workspace Review tab         | `WorkbenchTab.reviewSubtab`                                 | Changes                                                                         |
| File tab path and Diff/Preview/Edit choice                            | workspace + File tab id      | `WorkbenchTab.filePath` / `viewerMode`                      | new open intent chooses Diff/Preview/Edit                                       |
