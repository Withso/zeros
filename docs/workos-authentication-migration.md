...
| PlanetScale Postgres  | Single-use browser flow state, serialized sealed sessions, internal identity mapping and authorization                                     | Short-lived PKCE verifier and sealed session; no browser access-token column |
