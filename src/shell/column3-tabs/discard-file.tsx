...
// ──────────────────────────────────────────────────────────
//
// Used by BOTH the Changes-list row action and the row-1 diff header, so the
...
/** Resolve the safe git operation and the row-1 path lifecycle from a live
...
export function planDiscard(
  ...
  // destination path currently open in row 1. It is not a destructive "new
 ...
 *  no-op. Self-resolving keeps the Changes-list and row-1 Discard buttons
