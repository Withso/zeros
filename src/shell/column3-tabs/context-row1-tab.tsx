// ============================================
// COMPONENT: ContextRow1Tab
// PURPOSE: THE pinned row-1 Context tab — a pan/zoom canvas over the
...
// USED IN: Column3TabBody (column3-tabs.tsx)
// ============================================
...
export const ContextRow1Tab = React.memo(function ContextRow1Tab({
  active,
}: TabBodyProps) {
  ...
  const body = !cwd ? (
    ...
    // chrome empty rather than a spinner (Rule 11: no cold-load theater).
    ...
    <>
      ...
      />
      {data.truncated && (
        <div className="text-fg3 border-border1 bg-bg1 border-t px-3 py-1.5 text-xxs">
