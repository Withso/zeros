...
// ──────────────────────────────────────────────────────────
//
// Column-3 surfaces are per-worktree, so switching workspaces UNMOUNTS the Files
// tab and mounts a fresh one (column3.tsx keys its bodies by scoped tab id). The
