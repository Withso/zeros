...
import type { ChatThread } from "../../zeros/store/store";
import { newChatId } from "../../zeros/store/chat-id";
...
export function DispatcherModal({
  ...
  const handleCreate = async (payload: DispatcherCreatePayload) => {
    ...
    //      path, mark it settling — Column 3 shows its "Setting up
    ...
    // Column 3 shows its loading rows from the very first frame; the flag
    ...
    // switching Column 2 to the new workspace THIS frame.
