...
// ============================================
//
// H1 of the Home/Settings consolidation (docs/home-tab-and-settings-ia-
// 2026-07-15.md §3.2): the rail holds DESTINATIONS — the Dashboard and the
// repos. Settings is configuration, so it left the nav list and lives behind
// the profile card's gear (and ⌘,), the Figma pattern. Repo rows NAVIGATE to
// the repo page (Workspaces | Settings tabs) — they are not Dashboard
// filters; the Dashboard keeps its own filter chips, unchanged.
//
...
import { prefetchSettingsForRepo } from "../zeros/settings/use-settings";
