// ──────────────────────────────────────────────────────────
// Run control — row-2 terminal header split-button over repo run actions
// ──────────────────────────────────────────────────────────
//
...
import { RunHorseShimmer } from "@/loaders";
import { nativeListen } from "../../native/runtime";
import { type WorkspaceRunActionStatus } from "../../native/git";
...
import { useOpenScriptsSettings } from "../column3-tabs/setup-tab";
...
export function RunControl({
  ...
  /** Expand/reveal row 2 (the selected Run tab is handled here). */
