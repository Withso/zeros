// ──────────────────────────────────────────────────────────
// Control-plane client — the Mac app's door to the Zeros backend
// (backend/: teams, membership, invitations; docs/teams.md Part E).
//
 ...
 *  see backend/migrations/0007_staff_role.sql. */
