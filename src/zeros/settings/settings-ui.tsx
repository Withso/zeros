...
// Settings-foundation Phase 3 retired the `rounded-lg border bg-bg3 p-6`
// card that wrapped every group — the page reads as flat sections of
...
// NOT `text-sm` — 2026-07-20 founder direction is names 14px / everything
...
// pulls `.text-sm` controls down to 13px (globals.css §11). It equals the
