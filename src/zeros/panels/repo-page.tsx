...
// PURPOSE: The Home tab's per-repo hub (H1 of docs/home-tab-and-settings-ia-
//          2026-07-15.md §3.4, revised 2026-07-16). A CENTERED page column:
//          the repo's logo + name on top, ONE segmented toggle below it —
...
//          the personal file in Finder (created on first use) — the in-app
//          raw-TOML editor left this page (founder direction 2026-07-16:
//          hand-edits happen in your own editor, not a UI code box).
//
...
//
//          v3 D1: settings editing is PERSONAL-LENS ONLY — every write lands
...
import { RepositoryIcon } from "../ui/repository-icon";
import {
  selectRepoPageView,
  useActivePage,
  useChats,
...
import { useOpenWorkspace } from "../store/use-open-workspace";
import { useArchiveWorkspace } from "../store/archive-actions";
 ...
 *  in Finder — the file the repo's Settings tabs actually write to (v3 D1:
