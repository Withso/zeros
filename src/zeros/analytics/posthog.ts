// ──────────────────────────────────────────────────────────
// PostHog analytics — renderer client (Phase 1)
// ──────────────────────────────────────────────────────────
//
// Anonymous, metadata-only product analytics + error tracking.
// Full plan + privacy contract: docs/posthog-analytics-integration.md.
//
...
// mode (electron/runtime-mode.ts via the app_info IPC command), so
 ...
 *  project key is configured (true for the open-source/contributor build, and
 *  on web until VITE_POSTHOG_KEY_PROD is set). Runs on desktop AND web. */
