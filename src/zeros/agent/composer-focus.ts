 ...
 *       (column 3). Column 3 is a sibling of the pane tree, and several of its
 ...
 *       what actually honors the "only column 3 defocuses the composer" rule.
 *
 ...
 *      a click in column 3 or another pane keeps its own focus,
 ...
 *      another input / menu / dialog, or a column-3 surface a click just opened.
 */
