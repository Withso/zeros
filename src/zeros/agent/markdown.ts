 ...
 *  100%` table CSS (see styles/globals.css).
 *
 *  Why this exists:
 *
 ...
 *   empty gutter on a wide col-2 (the bug the user reported via the
 *   Cursor-agent screenshot, 2026-05-23). Moving overflow + border
