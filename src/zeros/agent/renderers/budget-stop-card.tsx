// ──────────────────────────────────────────────────────────
// BudgetStopRecordCard — §3.6 R3 · "Turn stopped · BUDGET · CLAUDE"
// ──────────────────────────────────────────────────────────
//
...
// a footer status pill (the card already names the ending; user spec
// 2026-07-13). The footer's Continue starts a fresh turn under a fresh cap.
//
  ...
  function BudgetStopRecordCard({ message, ctx }) {
    ...
    const chips = (
      <span className="flex shrink-0 items-center gap-1.5">
        <span className="border-border1 text-fg2 flex shrink-0 items-center rounded-sm border px-1.5 py-0.5 font-mono text-xxs tracking-wide uppercase">
          Budget
        </span>
        {/* Muted scope pill — budget caps are Claude-only for now. */}
        <span className="bg-bg1-hover text-fg3 flex shrink-0 items-center rounded-sm px-1.5 py-0.5 font-mono text-xxs tracking-wide uppercase">
          Claude
        </span>
      </span>
    );
