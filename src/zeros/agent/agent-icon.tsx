...
async function fetchSvg(url: string): Promise<string> {
  ...
  const p = (async () => {
    ...
    // H15: the icon URL comes from registry metadata and is injected via
...
export interface AgentIconProps {
  ...
  /** Phase D2 (2026-05-07): when true, skip the brand-color recolor
...
export function AgentIcon({
  ...
  // future additions whose mark hasn't been added to src/assets/agents/).
