// ──────────────────────────────────────────────────────────
// reliability-settings — §3.6 R2/R3 · fallback model + budget cap
// ──────────────────────────────────────────────────────────
//
// Two global Claude Code knobs from Settings → Models:
//
//   • Fallback model (R2) — used automatically when the primary model is
...
//   • Budget cap (R3) — a per-turn USD ceiling (SDK `Options.maxBudgetUsd`).
