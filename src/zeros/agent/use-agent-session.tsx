...
// owned the whole session lifecycle. Phase 0 refactor (2026-05-07)
// split that into:
...
// @zeros/core (Phase 2b) so the engine can run the SAME coalescer it does. Re-
...
export * from "@zeros/core/agent-messages";
import type {
  AgentMessage,
...
export interface AgentUsage {
  ...
  costUsd?: number;
  /** Per-category context breakdown for the gauge popover (§3.5 Task C).
...
export interface AgentSessionState {
  ...
  /** Phase 2 chat overhaul (2026-05-07): the chat's folder, captured
   *  on first ensureSession + restored on rebuilds. Without this, the
   *  Phase B1/B2 silent-retry path called ensureSession({ force:true })
