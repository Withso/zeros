...
export const JumpToPromptPill = memo(function JumpToPromptPill({
  ...
  return (
    <Tooltip label="Jump to your prompt">
      <button
        type="button"
        className="zeros-agent-jump-pill zeros-agent-jump-pill-top absolute right-[14px] top-3 z-10 inline-flex cursor-pointer items-center gap-1.5 rounded-sm border border-border1 bg-bg2 px-3 py-1.5 text-xs leading-none text-fg1 hover:bg-bg2-hover [animation:ocAgentJumpPillIn_140ms_ease-out]"
...
export const JumpToLatestButton = memo(function JumpToLatestButton({
  ...
  return (
    <Tooltip label="Jump to latest">
      <button
        type="button"
        className="zeros-agent-jump-pill zeros-agent-jump-pill-bottom absolute bottom-full left-1/2 z-10 mb-2 inline-flex size-9 -translate-x-1/2 cursor-pointer items-center justify-center rounded-sm border border-border1 bg-bg2 text-fg1 transition-colors hover:bg-bg2-hover [animation:ocAgentJumpPillIn_140ms_ease-out]"
