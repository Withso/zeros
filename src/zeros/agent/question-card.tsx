...
//
// Emits a canonical QuestionResponse; the engine adapter reshapes it per vendor.
// See docs/unified-question-card-plan-2026-07-02.md.
// ──────────────────────────────────────────────────────────
...
/** Codex sends no multiSelect flag → default MULTI (user decision 2026-07-02);
 *  Claude sets it explicitly. */
      ...
      <div className="border-border1 bg-bg1 flex w-full min-w-0 flex-col gap-3 rounded-lg border px-3.5 py-3">
        <div className="flex items-start gap-2">
          {/* Scope/header chip (e.g. COMPONENT SOURCE) intentionally not
            rendered — user feedback 2026-07-04. */}
