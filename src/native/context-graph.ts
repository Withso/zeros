...
// `local/` scope is gitignored private material), so web clients short-
 ...
 *  a web client resolves to the empty non-existent graph. */
...
/** Idempotently create the graph skeleton. Best-effort on web (no-op). */
