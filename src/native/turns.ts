...
// exact-key UI caches to retain their last confirmed snapshot. Engine source-of-truth: src/engine/db/turns.ts +
// src/engine/git/turns-git.ts; the types below mirror those exports so the React
...
/** §3.6 R6 — one model's share of a turn's bill (usage popover rows). */
...
/** §3.6 R6 — per-turn token/cost usage (mirrors engine db/turns.TurnUsageJson).
...
export interface TurnInfo {
  ...
  files: TurnFile[];
  /** §3.6 R6 — tokens/cost this turn billed (null when none was reported). */
