...
// iterable so the SDK process exits cleanly. It is the exact pattern
// Paseo and t3code use to wrap the SDK's single-shot `query()` into a
// long-lived, stateful session.
//
// ──────────────────────────────────────────────────────────
