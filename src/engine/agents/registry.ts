...
export type AuthProbe =
   ...
   *  var at spawn (electron/sidecar.ts). Authenticated iff the file holds a
...
function readClaudeBundledCliVersion(): string | null {
  ...
  // electron/sidecar.ts resolveClaudeCliPaths + claude-sdk/binary-resolver.ts).
...
function readCodexBundledVersion(): string | null {
  ...
  // ZEROS_CODEX_CLI_VERSION today: electron/sidecar.ts forwards only the Claude pair
