 ...
 *  the engine (electron/sidecar.ts). Unset when the engine runs standalone
 ...
 *  for the full 30-min TTL even after the user pastes a fresh key
 *  (Cursor, user report 2026-07-04). */
