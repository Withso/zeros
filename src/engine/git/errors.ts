...
// match on `code` to decide UX (e.g. BRANCH_IN_USE → offer the 3-option
// resolution dialog described in roadmap 03a).
...
export type GitErrorCode =
  ...
  | "REMOTE_RESTRICTED"
  | "REMOTE_PATH_DENIED"
  // Settings TOML ops (src/engine/settings/ops.ts — surfaced via the same
