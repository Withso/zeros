...
// See docs/workspace-state-and-performance.md.
//
 ...
 *  no slug. THE single identity generator: electron/main.ts redirects Electron's
 ...
 *  shared dev secrets.json (electron/secret-store.ts + ZEROS_SHARED_SECRETS_DIR),
...
/** The per-engine-root RUNTIME dir, inside the app-data home (§3.1). Holds the
