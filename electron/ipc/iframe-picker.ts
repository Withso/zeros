...
// ──────────────────────────────────────────────────────────
//
// Roadmap 03b Stage 2 of the iframe migration. Replaces the
// deleted WebContentsView preload-script lifecycle. Two pieces:
//
...
import { isLoopbackUrl } from "../../src/shell/column3-tabs/localhost-url";
