...
const commandTable: Record<string, CommandHandler> = {
  ...
  // electron/ipc/commands/auth-session.ts. (legacy auth_storage_*/
  ...
  // See electron/ipc/commands/auth-handoff.ts.
  ...
  // ── Keychain / css / skills / localhost (Phase 5) ──
  ...
  // ── Workspace lifecycle (roadmap 03a — phase 1) ───────────
  ...
  // Theme plumbing (registered in commands/index.ts): the renderer reports the
