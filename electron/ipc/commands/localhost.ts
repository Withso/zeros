...
const KNOWN_PORTS: Array<{
  ...
  // Dev servers — the Zeros website cluster lives in 3000–3002, and
  // the Mac-app renderer runs on 5193 (pinned, see vite.config.ts).
  // All other entries are common third-party tool defaults the user
  // is likely to spin up in the project they're inspecting.
  { port: 3000, kind: "dev-server", label: "Next.js / CRA / Zeros marketing" },
  { port: 3001, kind: "dev-server", label: "Zeros accounts" },
