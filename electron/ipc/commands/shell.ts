 ...
 *  bundled set (H2) — the character allowlist alone can't help, because a real
 ...
 *  literal. Shared with open-apps.ts (opencode-in-Terminal launch). */
...
export const openInstallTerminal: CommandHandler = (args) => {
  // H2: only run a command that is EXACTLY one of the bundled install one-liners.
